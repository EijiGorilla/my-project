import{yw as Q,Id as Z,Ie as ee,GJ as te,GH as ie,If as re,Ig as ae,GO as o,I6 as se,Hl as oe,I5 as ne,GN as w,Ih as ce,Ii as le,GK as pe,GM as de,GP as he,HN as ve,GR as ue,Ij as N,Ik as F,Il as me,Im as fe,Hp as ge,cX as Se,GS as Pe,GT as ye,j as _e,GU as M,GW as G,GX as we,GY as R,GZ as I,Hq as ze,G$ as xe,H0 as $e,H2 as Te,G_ as be,H3 as V,In as Ve,Io as U,Ip as H,Iq as ke,Ir as Oe,Is as De,H4 as We,_ as p,H5 as d,cU as Ce,Hs as Me,It as E,t8 as Ie,HY as Le,mz as je,Ha as Ae,ar as B,as as Y,Ak as Ne,dN as q,Iu as Fe}from"./index-DWB-5FUE.js";function J(r){const e=new Q,{space:i,anchor:t,hasTip:P,hasScreenSizePerspective:z}=r,u=i===2,g=i===1;e.include(Z,r),e.include(ee,r),e.include(te,r);const{vertex:a,fragment:S,varyings:y}=e;ie(a,r),e.attributes.add("position","vec3"),e.attributes.add("previousDelta","vec4"),e.attributes.add("uv0","vec2"),y.add("vColor","vec4"),y.add("vpos","vec3",{invariant:!0}),y.add("vUV","vec2"),y.add("vSize","float"),P&&y.add("vLineWidth","float"),a.uniforms.add(new re("nearFar",({camera:l})=>l.nearFar),new ae("viewport",({camera:l})=>l.fullViewport)).code.add(o`vec4 projectAndScale(vec4 pos) {
...
return clamp(0.5 - pixelDistance, 0.0, 1.0);
}`),P&&(e.include(F),S.constants.add("relativeMarkerSize","float",me/N).constants.add("relativeTipLineWidth","float",fe).code.add(o`
  ...
  `)),e.include(ge,r),e.include(F),S.main.add(o`
    ...
    outputColorHighlightOID(finalColor, vpos, finalColor.rgb);`),e}const Ge=Object.freeze(Object.defineProperty({__proto__:null,build:J},Symbol.toStringTag,{value:"Module"}));let Re=class extends Pe{constructor(e,i){super(e,i,new ye(Ge,()=>_e(()=>Promise.resolve().then(()=>Ye),void 0)),X(i).locations)}_makePipelineState(e,i){const{output:t,oitPass:P,space:z,hasOccludees:u}=e;return M({blending:V(t)?Te(P):null,depthTest:z===0?null:{func:$e(P)},depthWrite:xe(e),drawBuffers:ze(t,be(P,t)),colorWrite:I,stencilWrite:u?R:null,stencilTest:u?i?G:we:null,polygonOffset:{factor:0,units:-10}})}initializePipeline(e){return e.occluder?(this._occluderPipelineTransparent=M({blending:H,depthTest:U,depthWrite:null,colorWrite:I,stencilWrite:null,stencilTest:Ve}),this._occluderPipelineOpaque=M({blending:H,depthTest:U,depthWrite:null,colorWrite:I,stencilWrite:Oe,stencilTest:ke}),this._occluderPipelineMaskWrite=M({blending:null,depthTest:De,depthWrite:null,colorWrite:null,stencilWrite:R,stencilTest:G})):this._occluderPipelineTransparent=this._occluderPipelineOpaque=this._occluderPipelineMaskWrite=null,this._occludeePipelineState=this._makePipelineState(e,!0),this._makePipelineState(e,!1)}getPipeline(e,i){return e?this._occludeePipelineState:i===11?this._occluderPipelineTransparent??super.getPipeline():i===10?this._occluderPipelineOpaque??super.getPipeline():this._occluderPipelineMaskWrite??super.getPipeline()}};function X(r){const e=Se().vec3f("position").vec4f16("previousDelta").vec2f16("uv0");return r.hasVVColor?e.f32("colorFeatureAttribute"):e.vec4u8("color",{glNormalized:!0}),r.hasVVOpacity&&e.f32("opacityFeatureAttribute"),r.hasVVSize?e.f32("sizeFeatureAttribute"):e.f16("size"),r.worldSpace&&e.vec3f16("normal"),e.freeze()}class c extends We{constructor(e){super(),this.spherical=e,this.space=1,this.anchor=0,this.occluder=!1,this.writeDepth=!1,this.hideOnShortSegments=!1,this.hasCap=!1,this.hasTip=!1,this.hasVVSize=!1,this.hasVVColor=!1,this.hasVVOpacity=!1,this.hasOccludees=!1,this.terrainDepthTest=!1,this.cullAboveTerrain=!1,this.hasScreenSizePerspective=!1,this.textureCoordinateType=0,this.emissionSource=0,this.discardInvisibleFragments=!0,this.occlusionPass=!1,this.hasVVInstancing=!1,this.hasSliceTranslatedView=!0,this.olidColorInstanced=!1,this.overlayEnabled=!1,this.snowCover=!1}get draped(){return this.space===0}get worldSpace(){return this.space===2}}p([d({count:3})],c.prototype,"space",void 0),p([d({count:2})],c.prototype,"anchor",void 0),p([d()],c.prototype,"occluder",void 0),p([d()],c.prototype,"writeDepth",void 0),p([d()],c.prototype,"hideOnShortSegments",void 0),p([d()],c.prototype,"hasCap",void 0),p([d()],c.prototype,"hasTip",void 0),p([d()],c.prototype,"hasVVSize",void 0),p([d()],c.prototype,"hasVVColor",void 0),p([d()],c.prototype,"hasVVOpacity",void 0),p([d()],c.prototype,"hasOccludees",void 0),p([d()],c.prototype,"terrainDepthTest",void 0),p([d()],c.prototype,"cullAboveTerrain",void 0),p([d()],c.prototype,"hasScreenSizePerspective",void 0);class Ke extends Ce{constructor(e,i){super(e,He),this.produces=new Map([[2,t=>t===9||V(t)&&this.parameters.renderOccluded===8],[3,t=>Me(t)],[10,t=>E(t)&&this.parameters.renderOccluded===8],[11,t=>E(t)&&this.parameters.renderOccluded===8],[4,t=>V(t)&&this.parameters.writeDepth],[8,t=>V(t)&&!this.parameters.writeDepth],[18,t=>V(t)||t===9]]),this.intersectDraped=void 0,this._configuration=new c(i)}getConfiguration(e,i){return super.getConfiguration(e,i,this._configuration),this._configuration.space=i.slot===18?0:this.parameters.worldSpace?2:1,this._configuration.hideOnShortSegments=this.parameters.hideOnShortSegments,this._configuration.hasCap=this.parameters.cap!==0,this._configuration.anchor=this.parameters.anchor,this._configuration.hasTip=this.parameters.hasTip,this._configuration.hasSlicePlane=this.parameters.hasSlicePlane,this._configuration.hasOccludees=i.hasOccludees,this._configuration.writeDepth=this.parameters.writeDepth,this._configuration.hasVVSize=this.parameters.hasVVSize,this._configuration.hasVVColor=this.parameters.hasVVColor,this._configuration.hasVVOpacity=this.parameters.hasVVOpacity,this._configuration.occluder=this.parameters.renderOccluded===8,this._configuration.oitPass=i.oitPass,this._configuration.terrainDepthTest=i.terrainDepthTest&&V(e),this._configuration.cullAboveTerrain=i.cullAboveTerrain,this._configuration.hasScreenSizePerspective=this.parameters.screenSizePerspective!=null,this._configuration}get visible(){return this.parameters.color[3]>=Ie}intersect(){}createBufferWriter(){return new Ee(X(this.parameters),this.parameters)}createGLMaterial(e){return new Ue(e)}}class Ue extends Ae{dispose(){super.dispose(),this._markerTextures?.release(this._markerPrimitive),this._markerPrimitive=null}beginSlot(e){const i=this._material.parameters.markerPrimitive;return i!==this._markerPrimitive&&(this._material.setParameters({markerTexture:this._markerTextures.swap(i,this._markerPrimitive)}),this._markerPrimitive=i),this.getTechnique(Re,e)}}class He extends Le{constructor(){super(...arguments),this.width=0,this.color=[1,1,1,1],this.markerPrimitive="arrow",this.placement="end",this.cap=0,this.anchor=0,this.hasTip=!1,this.worldSpace=!1,this.hideOnShortSegments=!1,this.writeDepth=!0,this.hasSlicePlane=!1,this.vvFastUpdate=!1,this.stipplePattern=null,this.markerTexture=null}}class Ee{constructor(e,i){this.layout=e,this._parameters=i}elementCount(){return this._parameters.placement==="begin-end"?12:6}write(e,i,t,P,z,u){const g=t.get("position").data,a=g.length/3;let S=[1,0,0];const y=t.get("normal");this._parameters.worldSpace&&y!=null&&(S=y.data);let h=1,l=0;this._parameters.vvSize?l=t.get("sizeFeatureAttribute").data[0]:t.has("size")&&(h=t.get("size").data[0]);let $=[1,1,1,1],L=0;this._parameters.vvColor?L=t.get("colorFeatureAttribute").data[0]:t.has("color")&&($=t.get("color").data);let j=0;this._parameters.vvOpacity&&(j=t.get("opacityFeatureAttribute").data[0]);const x=new Float32Array(z.buffer),_=je(z.buffer),k=new Uint8Array(z.buffer);let v=u*(this.layout.stride/4);const T=x.BYTES_PER_ELEMENT/_.BYTES_PER_ELEMENT,K=4/T,b=(n,D,m,f)=>{x[v++]=n[0],x[v++]=n[1],x[v++]=n[2],Fe(D,n,_,v*T),v+=K;let s=v*T;if(_[s++]=m[0],_[s++]=m[1],v=Math.ceil(s/T),this._parameters.vvColor)x[v++]=L;else{const W=Math.min(4*f,$.length-4),C=4*v++;k[C]=255*$[W],k[C+1]=255*$[W+1],k[C+2]=255*$[W+2],k[C+3]=255*$[W+3]}this._parameters.vvOpacity&&(x[v++]=j),s=v*T,this._parameters.vvSize?(x[v++]=l,s+=2):_[s++]=h,this._parameters.worldSpace&&(_[s++]=S[0],_[s++]=S[1],_[s++]=S[2]),v=Math.ceil(s/T)},A=(n,D)=>{const m=B(Be,g[3*n],g[3*n+1],g[3*n+2]),f=qe;let s=n+D;do B(f,g[3*s],g[3*s+1],g[3*s+2]),s+=D;while(Ne(m,f)&&s>=0&&s<a);e&&(q(m,m,e),q(f,f,e)),b(m,f,[-1,-1],n),b(m,f,[1,-1],n),b(m,f,[1,1],n),b(m,f,[-1,-1],n),b(m,f,[1,1],n),b(m,f,[-1,1],n)},O=this._parameters.placement;return O!=="begin"&&O!=="begin-end"||A(0,1),O!=="end"&&O!=="begin-end"||A(a-1,-1),null}}const Be=Y(),qe=Y(),Ye=Object.freeze(Object.defineProperty({__proto__:null,build:J},Symbol.toStringTag,{value:"Module"}));export{Ke as g};
