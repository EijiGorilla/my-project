import{kG as A,aG as M,at,k$ as Ne,kJ as le,ow as ee,tl as rt,rF as ce,tm as st,kI as lt,kK as ct,kM as ft,kL as ut,kF as H,ql as dt,fL as _t,jd as vt,tn as ht,aK as k,be as ge,to as mt,ax as oe,oM as Fe,av as ve,tp as pt,tq as gt,tr as yt,ts as xt,d0 as St,d2 as Tt,aN as It,tt as N,tu as Be,kO as ye,br as bt,bq as Et,tv as xe,r as Ue,kY as Ot,g5 as Se,j9 as At,N as Pt,tw as Mt}from"./index-Cf-lFAZt.js";import{$ as Ct,d as Te,f as Lt,g as Ye,s as z,t as zt,n as X,e as q,h as Ge}from"./Utils-B7yaZxYE.js";import{e as Dt,a as te}from"./ProgramTemplate-CuNvB7Yz.js";import{h as $}from"./VertexArrayObject-D7HLTERP.js";import{n as Rt}from"./VertexAttributeLocations-BfZbt_DV.js";import{t as ne}from"./VertexElementDescriptor-BLyltQyJ.js";import{r as j}from"./VertexBuffer-BJDRCe24.js";import{n as wt}from"./vec3f32-WCVSSNPR.js";import{e as ke,n as Vt}from"./Container-Bx91td-2.js";import{n as Nt}from"./memoryEstimations-g7avQRQA.js";import{o as fe}from"./BufferObject-CBejYZJ_.js";import{e as Ie}from"./config-BOD8--da.js";import{t as Ft,X as Bt}from"./featureConversionUtils-BbMyzts8.js";import{e as be}from"./OptimizedFeature-sY4rBJ0M.js";function He(){return new Float32Array(4)}function Ut(f){const e=new Float32Array(4);return e[0]=f[0],e[1]=f[1],e[2]=f[2],e[3]=f[3],e}function B(f,e,t,n){const i=new Float32Array(4);return i[0]=f,i[1]=e,i[2]=t,i[3]=n,i}function $e(){return He()}function We(){return B(1,1,1,1)}function Ze(){return B(1,0,0,0)}function je(){return B(0,1,0,0)}function Ke(){return B(0,0,1,0)}function qe(){return B(0,0,0,1)}const Yt=$e(),Gt=We(),kt=Ze(),Ht=je(),$t=Ke(),Wt=qe();Object.freeze(Object.defineProperty({__proto__:null,ONES:Gt,UNIT_W:Wt,UNIT_X:kt,UNIT_Y:Ht,UNIT_Z:$t,ZEROS:Yt,clone:Ut,create:He,fromValues:B,ones:We,unitW:qe,unitX:Ze,unitY:je,unitZ:Ke,zeros:$e},Symbol.toStringTag,{value:"Module"}));let U=class{constructor(){this.name=this.constructor.name||"UnnamedBrush",this.brushEffect=null}prepareState(e,t){}draw(e,t,n){}drawMany(e,t,n){for(const i of t)i.visible&&this.draw(e,i,n)}};const Zt={background:{"background.frag":`uniform lowp vec4 u_color;
void main() {
