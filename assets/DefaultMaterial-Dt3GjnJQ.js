const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/RealisticTree.glsl-7c9RUOHe.js","assets/index-DcRZY5kx.js","assets/index-CrqRI8IN.css","assets/HUDMaterial.glsl-Y94sN1l6.js","assets/meshVertexSpaceUtils-Dta9Id-h.js","assets/MeshLocalVertexSpace-CN9tNVoJ.js","assets/hydratedFeatures-DnmJXUVN.js","assets/vec3f32-WCVSSNPR.js","assets/OutputColorHighlightOID.glsl-BLlApcGW.js","assets/Indices-DfQUWp03.js","assets/BufferView-BkGwg0rw.js","assets/renderState-CKc66y4x.js","assets/glsl-B5bJgrnA.js","assets/VertexAttributeLocations-BfZbt_DV.js","assets/VertexElementDescriptor-BLyltQyJ.js","assets/BooleanBindUniform-rV7lhEqP.js","assets/InterleavedLayout-BRE52VHV.js","assets/types-BKo2foNY.js","assets/ShaderBuilder-DG0ic514.js","assets/memoryEstimations-BPy2xfR4.js"])))=>i.map(i=>d[i]);
import{jz as ze,e1 as x,jf as k,e5 as $e,pE as et,df as At,f1 as Dt,jt as Gt,fL as V,ji as jt,vz as Bt,ql as Ht,kZ as Wt,vA as tt,X as c,Y as H,$ as at,vB as kt,vC as Ut,vD as Q,dT as ot,qA as Fe,jr as Ge,jg as Yt,n7 as qt,vE as U,_ as he,g5 as rt,kY as ne,bD as re,d0 as Zt,d2 as Xt,N as Jt,aN as Kt,kC as Qt,fm as ea,pD as z,f6 as ta,b0 as aa,ej as oa,e3 as ra,es as ia,fI as be,fA as na,eW as je,fz as sa,jd as la,vF as ca}from"./index-DcRZY5kx.js";import{a4 as E,N as me,H as pe,a5 as I,c as it,a6 as fe,a7 as nt,a8 as st,a9 as da,aa as W,ab as ua,ac as ha,ad as ma,U as pa,ae as J,W as O,E as ae,f as A,af as D,u as K,R as y,p as G,ag as fa,d as va,ah as lt,Z as se,ai as ct,Q as dt,aj as ut,V as ga,g as Ne,t as ve,_ as ht,ak as xa,J as ba,$ as wa,a0 as Be,al as ya,am as _,an as Oe,ao as Ma,T as ee,ap as Ta,x as oe,aq as _a,b as Sa,M as le,e as mt,i as pt,ar as ft,a as vt,h as Ca,q as za,j as $a,k as Fa,l as Na,o as Oa,r as Ia,v as La,w as Va,y as Ea,z as m,s as Ra,as as we,at as ye,D as Pa,au as Aa}from"./OutputColorHighlightOID.glsl-BLlApcGW.js";import{o as j,i as Da,a as Ga,n as gt,r as xt,h as ja,s as Ba,b as Ha}from"./BooleanBindUniform-rV7lhEqP.js";import{t as Ce,Q as Ie}from"./InterleavedLayout-BRE52VHV.js";import{t as i,n as p}from"./glsl-B5bJgrnA.js";import{s as S,T as bt,g as ce,I as He}from"./BufferView-BkGwg0rw.js";import{r as Wa}from"./VertexBuffer-DKkzXTmw.js";import{s as ge}from"./ShaderBuilder-DG0ic514.js";import{T as Le,d as Ve,_ as ka}from"./renderState-CKc66y4x.js";import{t as Ua}from"./VertexAttributeLocations-BfZbt_DV.js";function xe(a,e){switch(a.fragment.code.add(i`vec3 screenDerivativeNormal(vec3 positionView) {
...
return color;
}`)}const Ue=k();function _t(a,e){const{hasModelTransformation:t,instancedDoublePrecision:o,instanced:r,output:s,hasVertexTangents:d}=e;t&&(a.vertex.uniforms.add(new da("model",l=>l.modelTransformation??Ge)),a.vertex.uniforms.add(new I("normalLocalOriginFromModel",l=>(Yt(Ue,l.modelTransformation??Ge),Ue)))),r&&o&&(a.attributes.add("instanceModelOriginHi","vec3"),a.attributes.add("instanceModelOriginLo","vec3"),a.attributes.add("instanceModel","mat3"),a.attributes.add("instanceModelNormal","mat3"));const n=a.vertex;o&&(n.include(Ya,e),n.uniforms.add(new W("viewOriginHi",l=>ua(V(ie,l.camera.viewInverseTransposeMatrix[3],l.camera.viewInverseTransposeMatrix[7],l.camera.viewInverseTransposeMatrix[11]),ie)),new W("viewOriginLo",l=>ha(V(ie,l.camera.viewInverseTransposeMatrix[3],l.camera.viewInverseTransposeMatrix[7],l.camera.viewInverseTransposeMatrix[11]),ie)))),n.code.add(i`
    ...
    }`)}const ie=x();function St(a,e){a.varyings.add("colorMixMode","int"),a.varyings.add("opacityMixMode","int"),a.vertex.uniforms.add(new pa("symbolColorMixMode",t=>J[t.colorMixMode])),e.hasSymbolColors?(a.vertex.include(fe),a.vertex.include(nt),a.vertex.include(st),a.attributes.add("symbolColor","vec4"),a.vertex.code.add(i`
...
gl_FragDepth = _linearDepth;
  ...
  `)}function Ct(a,e){const{vertex:t,fragment:o,varyings:r}=a,{hasColorTexture:s,alphaDiscardMode:d}=e,n=s&&d!==1,{output:l,normalType:u,hasColorTextureTransform:f}=e;switch(l){case 2:A(t,e),a.include(j),o.include(G,e),a.include(D,e),n&&o.uniforms.add(new y("tex",v=>v.texture)),t.main.add(i`vpos = getVertexInLocalOriginSpace();
...
forwardTextureCoordinates();`),a.include(B,e),o.main.add(i`
        ...
        ${p(n,i`vec4 texColor = texture(tex, ${f?"colorUV":"vuv0"});
                discardOrAdjustAlpha(texColor);`)}`);break;case 4:case 5:case 6:case 7:case 10:A(t,e),a.include(j),a.include(D,e),a.include(K,e),a.include(co,e),o.include(G,e),a.include(va,e),Da(a),r.add("depth","float",{invariant:!0}),n&&o.uniforms.add(new y("tex",v=>v.texture)),t.main.add(i`vpos = getVertexInLocalOriginSpace();
vpos = subtractOrigin(vpos);
vpos = addVerticalOffset(vpos, localOrigin);
...
forwardObjectAndLayerIdColor();`),a.include(B,e),o.main.add(i`
        ...
        ${l===10?i`outputObjectAndLayerIdColor();`:i`outputDepth(depth);`}`);break;case 3:{A(t,e),a.include(j),a.include(xe,e),a.include(wt,e),a.include(D,e),a.include(K,e),n&&o.uniforms.add(new y("tex",M=>M.texture)),u===2&&r.add("vPositionView","vec3",{invariant:!0});const v=u===0||u===1;t.main.add(i`
        vpos = getVertexInLocalOriginSpace();
        ${v?i`vNormalWorld = dpNormalView(vvLocalNormal(normalModel()));`:i`vPositionView = (view * vec4(vpos, 1.0)).xyz;`}
        vpos = subtractOrigin(vpos);
        vpos = addVerticalOffset(vpos, localOrigin);
        gl_Position = transformPosition(proj, view, vpos);
        forwardTextureCoordinates();`),o.include(G,e),a.include(B,e),o.main.add(i`
        discardBySlice(vpos);
        ${p(n,i`vec4 texColor = texture(tex, ${f?"colorUV":"vuv0"});
                discardOrAdjustAlpha(texColor);`)}
        ...
        fragColor = vec4(0.5 + 0.5 * normal, 1.0);`);break}case 9:A(t,e),a.include(j),a.include(D,e),a.include(K,e),n&&o.uniforms.add(new y("tex",v=>v.texture)),t.main.add(i`vpos = getVertexInLocalOriginSpace();
vpos = subtractOrigin(vpos);
vpos = addVerticalOffset(vpos, localOrigin);
gl_Position = transformPosition(proj, view, vpos);
forwardTextureCoordinates();`),o.include(G,e),a.include(B,e),a.include(fa,e),o.main.add(i`
        discardBySlice(vpos);
        ${p(n,i`vec4 texColor = texture(tex, ${f?"colorUV":"vuv0"});
                discardOrAdjustAlpha(texColor);`)}
...
return mix(mrr, vec3(0.0, 1.0, 0.04), snow);
}`))}function Ho(a){const e=new ge,{attributes:t,vertex:o,fragment:r,varyings:s}=e,{output:d,normalType:n,offsetBackfaces:l,spherical:u,snowCover:f,pbrMode:v,textureAlphaPremultiplied:M,instancedDoublePrecision:C,hasVertexColors:g,hasVertexTangents:F,hasColorTexture:N,hasNormalTexture:Y,hasNormalTextureTransform:R,hasColorTextureTransform:P}=a;if(A(o,a),t.add("position","vec3"),s.add("vpos","vec3",{invariant:!0}),e.include(K,a),e.include(_t,a),e.include(gt,a),e.include(Ao,a),!oe(d))return e.include(Ct,a),e;e.include(Do,a),e.include(Go,a),e.include(jo,a),e.include(Bo,a),le(o,a),e.include(xe,a),e.include(j);const L=n===0||n===1;return L&&l&&e.include(Mt),e.include(ho,a),e.include(wt,a),e.include(Tt,a),s.add("vPositionLocal","vec3"),e.include(D,a),e.include(St,a),e.include(xt,a),o.uniforms.add(new mt("externalColor",b=>b.externalColor,{supportsNaN:!0})),s.add("vcolorExt","vec4"),e.include(pt,a),o.include(fe),o.include(ft),e.include(C?Nt:Ot,a),o.main.add(i`
  ...
  `);const{hasColorTexture:M,hasColorTextureTransform:C}=a;return e.include(zt,a),r.include(Re,a),e.include(B,a),r.include(G,a),e.include(vt,a),le(r,a),ue(r),Ae(r),De(r),r.uniforms.add(o.uniforms.get("localOrigin"),o.uniforms.get("view"),new ee("ambient",g=>g.ambient),new ee("diffuse",g=>g.diffuse),new O("opacity",g=>g.opacity),new O("layerOpacity",g=>g.layerOpacity)),M&&r.uniforms.add(new y("tex",g=>g.texture)),e.include($t,a),r.include(Pe,a),r.include(Lt),r.include(Vt,a),te(r),r.main.add(i`
      discardBySlice(vpos);
      discardByTerrainDepth();
