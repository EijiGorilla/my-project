import{vU as K,Fs as Z,Ft as ee,D_ as te,DY as ie,Fu as re,Fv as ae,E3 as o,Fl as se,EC as oe,Fk as ne,E2 as w,Fw as ce,Fx as le,D$ as pe,E1 as de,E4 as he,F2 as ve,E6 as ue,Fy as A,Fz as N,FA as me,FB as fe,EG as ge,cX as Se,E7 as Pe,E8 as ye,j as _e,E9 as C,Eb as U,Ec as we,Ed as R,Ee as W,EH as ze,Eg as xe,Eh as $e,Ej as be,Ef as Te,Ek as k,FC as ke,FD as I,FE as B,FF as Ve,FG as De,FH as Oe,El as Fe,_ as p,Em as d,cU as Ee,EJ as Ce,FI as q,qY as We,Fc as Me,kE as Le,Er as je,as as H,at as G,xr as Ae,dO as Y,FJ as Ne}from"./index-Bncuv2b3.js";function J(r){const e=new K,{space:i,anchor:t,hasTip:P,hasScreenSizePerspective:z}=r,u=i===2,g=i===1;e.include(Z,r),e.include(ee,r),e.include(te,r);const{vertex:a,fragment:S,varyings:y}=e;ie(a,r),e.attributes.add("position","vec3"),e.attributes.add("previousDelta","vec4"),e.attributes.add("uv0","vec2"),y.add("vColor","vec4"),y.add("vpos","vec3",{invariant:!0}),y.add("vUV","vec2"),y.add("vSize","float"),P&&y.add("vLineWidth","float"),a.uniforms.add(new re("nearFar",({camera:l})=>l.nearFar),new ae("viewport",({camera:l})=>l.fullViewport)).code.add(o`vec4 projectAndScale(vec4 pos) {
